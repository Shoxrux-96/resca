...
import { Bell, AlertTriangle, Package, X, Check } from "lucide-react";
...
export function NotificationsBell() {
  ...
  // Faqat admin va kassir ko'radi (faqat o'z venue ma'lumotlari)
  const allowed = (role === "admin" || role === "kassir") && !!venueId;

  const { data: alerts = [] } = useQuery<InvAlert[]>({
    queryKey: ["inventory-alerts", venueId],
    enabled: !!venueId && !!token && allowed,
